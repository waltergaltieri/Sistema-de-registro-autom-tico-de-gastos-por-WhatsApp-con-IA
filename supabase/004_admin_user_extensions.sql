...
-- For users_profile: Drop old admin policy and create a new one supporting admin and super_admin
...
-- For expense_categories: Drop old admin policy and create a new one supporting admin and super_admin
...
-- For bot_message_logs: Drop old admin policy and create a new one supporting admin and super_admin
